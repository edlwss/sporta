Тема: Разработка автоматизированной информационной системы управления учебно-тренировочными процессами в спортивных комплексах 
с функцией мониторинга результативности обучения
...
1. Клонировать репозиторий
   git clone https://github.com/edlwss/cipinagora.git
...
- `POST /cipinagora/api/students/registration`  
  Регистрация нового студента в системе.

- `GET /cipinagora/api/students`  
  Получение списка всех студентов.

- `GET /cipinagora/api/student/{id}`  
  Получение информации о студенте по идентификатору.

- `PATCH /cipinagora/api/student/{id}/edit`  
  Обновление данных студента.

- `DELETE /cipinagora/api/student/{id}/delete`  
...
## ✏️ Примеры обновления данных студента
...
https://github.com/edlwss/cipinagora.git